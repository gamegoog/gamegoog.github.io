...
elements.ultraheat.extraInfo = "Heats elements at a rate of 350 degrees per millisecond.";
elements.ultracool.extraInfo = "Cools elements at a rate of 350 degrees per millisecond.";
elements.na_ntemp.extraInfo = "Cools an element down to NaN degrees.";
elements.inftemp.extraInfo = "Heats an element to an infinite number.";
