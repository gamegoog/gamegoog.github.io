function createUnityInstance(e, r, n) {
    function t(e) {
        ...
        (r && "string" == typeof r.stack && (n += "\n" + r.stack.substring(r.stack.lastIndexOf(n, 0) ? 0 : n.length).replace(/(^\n*|\n*$)/g, "")),
        n && l.stackTraceRegExp && l.stackTraceRegExp.test(n)) && a(n, e instanceof ErrorEvent ? e.filename : r && "string" == typeof r.fileName ? r.fileName : r && "string" == typeof r.sourceURL ? r.sourceURL : "", e instanceof ErrorEvent ? e.lineno : r && "number" == typeof r.lineNumber ? r.lineNumber : r && "number" == typeof r.line ? r.line : 0)
    }
    function o(e) {
        e.preventDefault()
    }
    function a(e, r, n) {
        l.startupErrorHandler ? l.startupErrorHandler(e, r, n) : l.errorHandler && l.errorHandler(e, r, n) || (console.log("Invoking error handler due to\n" + e),
        "function" == typeof dump && dump("Invoking error handler due to\n" + e),
        -1 != e.indexOf("UnknownError") || -1 != e.indexOf("Program terminated with exit(0)") || a.didShowErrorMessage) || (-1 != (e = "An error occurred running the Unity content on this page. See your browser JavaScript console for more info. The error was:\n" + e).indexOf("DISABLE_EXCEPTION_CATCHING") ? e = "An exception has occurred, but exception handling has been disabled in this build. If you are the developer of this content, enable exceptions in your project WebGL player settings to be able to catch the exception or see the stack trace." : -1 != e.indexOf("Cannot enlarge memory arrays") ? e = "Out of memory. If you are the developer of this content, try allocating more memory to your WebGL build in the WebGL player settings." : -1 == e.indexOf("Invalid array buffer length") && -1 == e.indexOf("Invalid typed array length") && -1 == e.indexOf("out of memory") && -1 == e.indexOf("could not allocate memory") || (e = "The browser could not allocate enough memory for the WebGL content. If you are the developer of this content, try allocating less memory to your WebGL build in the WebGL player settings."),
        alert(e),
        a.didShowErrorMessage = !0)
    }
    function i(e, r) {
        if ("symbolsUrl" != e) {
            (d = l.downloadProgress[e]) || (d = l.downloadProgress[e] = {
                started: !1,
                finished: !1,
                lengthComputable: !1,
                total: 0,
            ...
            "object" != typeof r || "progress" != r.type && "load" != r.type || (d.started || (d.started = !0,
            ...
            for (var e in l.downloadProgress) {
                var d;
                if (!(d = l.downloadProgress[e]).started)
                    return 0;
                a++,
                d.lengthComputable ? (t += d.loaded,
                o += d.total,
                i++) : d.finished || s++
            }
            n(.9 * (a ? (a - s - (o ? i * (o - t) / o : 0)) / a : 0))
        }
    }
    function s() {
    ...
    return l.SystemInfo = function() {
        ...
        (a = document.createElement("canvas")) && (gl = a.getContext("webgl2"),
        glVersion = gl ? 2 : 0,
    ...
    new Promise((function(e, r) {
        ...
        s()) : r("Your browser does not support WebAssembly.") : r("Your browser does not support WebGL.")
    }
    ))
}
